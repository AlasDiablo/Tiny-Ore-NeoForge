...
public class TinyOreBlocks {
    ...
    public static final DeferredBlock<Block> TINY_COAL_ORE     = register(
            (registryName) -> new TinyOreBlock(UniformInt.of(0, 1), ResourceKey.create(Registries.BLOCK, registryName)), TinyOreRegistries.TINY_COAL_ORE);
    public static final DeferredBlock<Block> TINY_COPPER_ORE   = register(
            (registryName) -> new TinyOreBlock(UniformInt.of(0, 1), ResourceKey.create(Registries.BLOCK, registryName)), TinyOreRegistries.TINY_COPPER_ORE);
    public static final DeferredBlock<Block> TINY_DIAMOND_ORE  = register(
            (registryName) -> new TinyOreBlock(UniformInt.of(1, 3), ResourceKey.create(Registries.BLOCK, registryName)), TinyOreRegistries.TINY_DIAMOND_ORE);
    public static final DeferredBlock<Block> TINY_EMERALD_ORE  = register(
            (registryName) -> new TinyOreBlock(UniformInt.of(1, 3), ResourceKey.create(Registries.BLOCK, registryName)), TinyOreRegistries.TINY_EMERALD_ORE);
    public static final DeferredBlock<Block> TINY_GOLD_ORE     = register(
            (registryName) -> new TinyOreBlock(UniformInt.of(0, 1), ResourceKey.create(Registries.BLOCK, registryName)), TinyOreRegistries.TINY_GOLD_ORE);
    public static final DeferredBlock<Block> TINY_IRON_ORE     = register(
            (registryName) -> new TinyOreBlock(UniformInt.of(0, 1), ResourceKey.create(Registries.BLOCK, registryName)), TinyOreRegistries.TINY_IRON_ORE);
    public static final DeferredBlock<Block> TINY_LAPIS_ORE    = register(
            (registryName) -> new TinyOreBlock(UniformInt.of(1, 2), ResourceKey.create(Registries.BLOCK, registryName)), TinyOreRegistries.TINY_LAPIS_ORE);
    public static final DeferredBlock<Block> TINY_REDSTONE_ORE = register(
            (registryName) -> new TinyRedStoneOreBlock(UniformInt.of(0, 2), ResourceKey.create(Registries.BLOCK, registryName)), TinyOreRegistries.TINY_REDSTONE_ORE);
    public static final DeferredBlock<Block> DEEPSLATE_TINY_COAL_ORE     = register(
            (registryName) -> new DeepslateTinyOreBlock(UniformInt.of(0, 1), ResourceKey.create(Registries.BLOCK, registryName)), TinyOreRegistries.DEEPSLATE_TINY_COAL_ORE);
    public static final DeferredBlock<Block> DEEPSLATE_TINY_COPPER_ORE   = register(
            (registryName) -> new DeepslateTinyOreBlock(UniformInt.of(0, 1), ResourceKey.create(Registries.BLOCK, registryName)), TinyOreRegistries.DEEPSLATE_TINY_COPPER_ORE);
    public static final DeferredBlock<Block> DEEPSLATE_TINY_DIAMOND_ORE  = register(
            (registryName) -> new DeepslateTinyOreBlock(UniformInt.of(1, 3), ResourceKey.create(Registries.BLOCK, registryName)), TinyOreRegistries.DEEPSLATE_TINY_DIAMOND_ORE);
    public static final DeferredBlock<Block> DEEPSLATE_TINY_EMERALD_ORE  = register(
            (registryName) -> new DeepslateTinyOreBlock(UniformInt.of(1, 3), ResourceKey.create(Registries.BLOCK, registryName)), TinyOreRegistries.DEEPSLATE_TINY_EMERALD_ORE);
    public static final DeferredBlock<Block> DEEPSLATE_TINY_GOLD_ORE     = register(
            (registryName) -> new DeepslateTinyOreBlock(UniformInt.of(0, 1), ResourceKey.create(Registries.BLOCK, registryName)), TinyOreRegistries.DEEPSLATE_TINY_GOLD_ORE);
    public static final DeferredBlock<Block> DEEPSLATE_TINY_IRON_ORE     = register(
            (registryName) -> new DeepslateTinyOreBlock(UniformInt.of(0, 1), ResourceKey.create(Registries.BLOCK, registryName)), TinyOreRegistries.DEEPSLATE_TINY_IRON_ORE);
    public static final DeferredBlock<Block> DEEPSLATE_TINY_LAPIS_ORE    = register(
            (registryName) -> new DeepslateTinyOreBlock(UniformInt.of(1, 2), ResourceKey.create(Registries.BLOCK, registryName)), TinyOreRegistries.DEEPSLATE_TINY_LAPIS_ORE);
    public static final DeferredBlock<Block> DEEPSLATE_TINY_REDSTONE_ORE = register(
            (registryName) -> new DeepslateTinyRedStoneOreBlock(UniformInt.of(0, 2), ResourceKey.create(Registries.BLOCK, registryName)), TinyOreRegistries.DEEPSLATE_TINY_REDSTONE_ORE);
